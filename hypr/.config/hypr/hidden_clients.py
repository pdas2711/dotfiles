...
if argv[1] == "minimize":
    ...
    curr_workspace = window_json["workspace"]["name"]
    print(curr_workspace)
    if "special" in curr_workspace:
        parent_workspace = curr_workspace.split(":")[1]
        client_address = window_json["address"]
        cmd = "hyprctl dispatch movetoworkspacesilent " + parent_workspace + ",address:" + client_address
