...
hl.bind(main_mod .. " + C", hl.dsp.exec_cmd("bemenu-run --binding vim --fb '#1e1e2e' --ff '#cdd6f4' --nb '#1e1e2e' --nf '#cdd6f4' --tb '#1e1e2e' --hb '#1e1e2e' --tf '#f38ba8' --hf '#f9e2af' --af '#cdd6f4' --ab '#1e1e2e'"))  -- Launch bemenu with Catppuccin Mocha color palette
